...
<GistWindow
  user="sheldonhull"
  gistId="764d2702bf9e783fca0263bbabd598a7"
  filename="pulumi-kubernetes-setup.go"
  title="[Use Pulumi With Kubernetes and Handle Loading Config as Well As Overrides] Not elegant but worked for round 1 #kubernetes #go #pulumi"lang="go"
/>
