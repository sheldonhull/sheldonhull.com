...
date: '2022-03-11T23:49:22+00:00'
slug: pulumi-secrets
tags:
- tech
- development
- pulumi
- go
description: Really appreciate the slick handling for stack level encrypted secrets.
---
...
I'm a fan of role based access like AWS Role assumption, using limited generated access tokens, etc (see [article on Leapp for a great example for local dev workflows](../2021/2021-06-28-simplify-aws-developer-security-with-leapp "simplify-aws-developer-security-with-leapp"))
