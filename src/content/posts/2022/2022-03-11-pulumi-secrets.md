...
I'm a fan of role based access like AWS Role assumption, using limited generated access tokens, etc (see [article on Leapp for a great example for local dev workflows](/simplify-aws-developer-security-with-leapp "simplify-aws-developer-security-with-leapp"))
