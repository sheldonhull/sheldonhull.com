...
<Aside type="info" title="Updated: 2020-04-29">
...
<GistWindow
  ...
  title="Download InfluxDB. A quick parsing of the html of the webpage to get you the latest URL version of the stable builds and download and unzip to local directory. This includes a download of whatever Chronograf version is available since at the time of this it was in beta and not a stable build"
  lang="powershell"
/>
...
<GistWindow
  ...
  title="open the influx command line and startup the console server if not currently running"
  lang="powershell"
/>
...
<Aside type="warning" title="Case Sensitivity">
