...
<GistWindow
  user="sheldonhull"
  gistId="e3ed8534b1565c67d6d59163b0921d59"
  filename="ExploreLogFilesObject.ps1"
  title="Exploring The Expansion of SMO Database Object Property"lang="powershell"
/>
...
<GistWindow
  user="sheldonhull"
  gistId="7314ffa3fc830f36a2eda8ee7e27f7c4"
  filename="RestoreDatabaseWithDbaTools.ps1"
  title="Example Of Using DbaTools To Restore Latest database backup"lang="powershell"
/>
...
<GistWindow
  user="sheldonhull"
  gistId="08fe28dd236a239f25821378268ef8e5"
  filename="Demo_UsingSMOToRestoreDb.ps1"
  title="Example of using SMO to restore a database"lang="powershell"
/>
