...
<GistWindow
  user="sheldonhull"
  gistId="ab043077045ed9d5f26b4bbf6b326f45"
  filename="ImplicitTruncationDemo.sql"
  title="Implicit truncation is risky, make sure to always define the length"lang="sql"
/>
