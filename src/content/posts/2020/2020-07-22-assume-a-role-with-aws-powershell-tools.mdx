...
<GistWindow
  ...
  title="[Assume Role & Temporary Credentials with AWS.Tools] Generating temporary credentials as well as assume role. Uses `NameIt` module for randomized session name fun.  #aws #awspowershell"
  lang="text"
/>
