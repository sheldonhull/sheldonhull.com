...
<GistWindow
  user="sheldonhull"
  gistId="e73dc7689be62dc7e8946d4ab948728b"
  filename="aws-cred-example"
  title="[Assume Role & Temporary Credentials with AWS.Tools] Generating temporary credentials as well as assume role. Uses `NameIt` module for randomized session name fun.  #aws #awspowershell"lang="text"
/>
...
<GistWindow
  user="sheldonhull"
  gistId="e73dc7689be62dc7e8946d4ab948728b"
  filename="aws-sts-assume-role-example.ps1"
  title="[Assume Role & Temporary Credentials with AWS.Tools] Generating temporary credentials as well as assume role. Uses `NameIt` module for randomized session name fun.  #aws #awspowershell"lang="powershell"
/>
...
<GistWindow
  user="sheldonhull"
  gistId="e73dc7689be62dc7e8946d4ab948728b"
  filename="vscode-snippet.json"
  title="[Assume Role & Temporary Credentials with AWS.Tools] Generating temporary credentials as well as assume role. Uses `NameIt` module for randomized session name fun.  #aws #awspowershell"lang="json"
/>
...
<GistWindow
  user="sheldonhull"
  gistId="e73dc7689be62dc7e8946d4ab948728b"
  filename="generate-temporary-credentials.ps1"
  title="[Assume Role & Temporary Credentials with AWS.Tools] Generating temporary credentials as well as assume role. Uses `NameIt` module for randomized session name fun.  #aws #awspowershell"lang="powershell"
/>
