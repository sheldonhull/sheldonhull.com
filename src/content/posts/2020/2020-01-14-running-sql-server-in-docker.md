---
date: 2020-01-16 13:00:00+00:00
title: Running SQL Server in Docker
slug: running-sql-server-in-docker
description: For development work, it can be freeing to leverage Docker to simplify
  spinning up a test SQL Server instance for your work
tags:
- devops
- docker
- sql-server
