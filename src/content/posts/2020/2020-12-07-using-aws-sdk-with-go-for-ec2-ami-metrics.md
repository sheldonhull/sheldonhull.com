---
date: 2020-12-07 17:08:14-06:00
title: Using AWS SDK With Go for EC2 AMI Metrics
slug: using-aws-sdk-with-go-for-ec2-ami-metrics
description: How I used the AWS SDK with Go to generate metrics for AWS EC2 Instances
  and AMI's associated to them
tags:
- tech
- development
- aws
...
From my prior blog post [Filtering Results In Go](/filtering-results-in-go "Filtering Results In Go") I also talked about this.
