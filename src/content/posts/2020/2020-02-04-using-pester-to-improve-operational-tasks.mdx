...
A classic example of unclear acceptance criteria and the wasteful impact of work is from a [youtube clip](https://www.youtube.com/watch?v=BTTdHW8Z668).
...
<Aside type="info" title="Pester Syntax">
