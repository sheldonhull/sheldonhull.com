...
<GistWindow
  ...
  filename="install-settings.ps1"
  title="my settings for windows 10 terminal. For keybindings allowed go to: [Windows Terminal Documentation](https://github.com/microsoft/terminal/blob/master/doc/cascadia/SettingsSchema.md)"lang="powershell"
/>
...
<GistWindow
  user="sheldonhull"
  gistId="93d8060e6f86e0c46535ef6699d6e0c8"
  filename="configure-profile-prompt.ps1"
  title="my settings for windows 10 terminal. For keybindings allowed go to: [Windows Terminal Documentation](https://github.com/microsoft/terminal/blob/master/doc/cascadia/SettingsSchema.md)"lang="powershell"
/>
