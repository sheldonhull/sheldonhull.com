...
<GistWindow
  ...
  title="my settings for windows 10 terminal. For keybindings allowed go to: [Windows Terminal Documentation](https://github.com/microsoft/terminal/blob/master/doc/cascadia/SettingsSchema.md)"
  lang="powershell"
/>
