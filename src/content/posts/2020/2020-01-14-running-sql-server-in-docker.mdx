...
<Aside type="info" title="Updated 2020-05-05">
...
<GistWindow
  user="sheldonhull"
  gistId="a70a3a731b329b67f47a331c64c72ab5"
  filename=".env"
  title="SQL Server Docker Compose can help you spin up a MSSQL instance with minimal effort for easier development work, testing through pester, and more."
  lang="text"
/>
