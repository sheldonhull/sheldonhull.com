...
<GistWindow
  user="sheldonhull"
  gistId="d2c4b009e7da1845081327121a61a05c"
  filename="Install-AWSSessionManager.ps1"
  title="Install Session Manager Plugin for AWS Systems Manager interactive sessions"lang="powershell"
/>
