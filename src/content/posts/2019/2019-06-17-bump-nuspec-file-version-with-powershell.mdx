...
<GistWindow
  user="sheldonhull"
  gistId="f0c2bd47e18e5d074c5e2b9943f79dfc"
  filename="version-bump.ps1"
  title="incrementally bump the version of a nuspec file, with support for what if and updated summary from readme"lang="powershell"
/>
