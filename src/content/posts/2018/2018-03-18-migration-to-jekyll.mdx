...
<GistWindow
  user="sheldonhull"
  gistId="c57c51882e7102e6b9b383443c115409"
  filename="BestMatchRemap.ps1"
  title="needed to remap urls for disqus with migration of site and this was something i used to help and blogged about"lang="powershell"
/>
