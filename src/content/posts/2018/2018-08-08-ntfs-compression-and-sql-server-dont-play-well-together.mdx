...
<GistWindow
  user="sheldonhull"
  gistId="c13eec8bbd570f762fd3834b19464465"
  filename="Database-CompressedFix.ps1"
  title="Move Database To C Drive to eliminate compression then move back folder after disabling compression on the destination folder"lang="powershell"
/>
...
<GistWindow
  user="sheldonhull"
  gistId="274861a17a7db002bddd55861b781719"
  filename="Database-Remount.ps1"
  title="Remount the newly fixed database"lang="powershell"
/>
