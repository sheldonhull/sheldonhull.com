...
<GistWindow
  ...
  title="Move Database To C Drive to eliminate compression then move back folder after disabling compression on the destination folder"
  lang="powershell"
/>
...
<GistWindow
  ...
  title="Remount the newly fixed database"
  lang="powershell"
/>
