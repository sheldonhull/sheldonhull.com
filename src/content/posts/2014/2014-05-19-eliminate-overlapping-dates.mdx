...
<GistWindow
  user="sheldonhull"
  gistId="8c7235ecb75bb91833e1"
  filename="TutorialEliminateOverlappingDueDates.sql"
  title="Eliminate Overlapping Dates, with subgroupings (such as overlap only eliminated at process > task level, instead of just process level)"lang="sql"
/>
