...
<GistWindow
  user="sheldonhull"
  gistId="4f8446420776336f7478"
  filename="create_or_proc_originalProposedSolution"
  title="OR_test_step1"lang="text"
/>
...
<GistWindow
  user="sheldonhull"
  gistId="ef2d134cdd3b47dcdf84"
  filename="or_index_to_add"
  title="OR test research and response"lang="text"
/>
