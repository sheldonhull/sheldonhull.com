...
<GistWindow
  user="sheldonhull"
  gistId="ab1a65ce636231e72214dc1acad30f6d"
  filename="DLL_ScanFolderForDllProcessorArchitecture.ps1"
  title="Powershell Scan Folder For DLL ProcessorArchitecture"lang="powershell"
/>
