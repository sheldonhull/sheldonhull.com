...
description: Improves to SSMS (Sql Server Management Studio) continue. Use the latest
...
If you want a shortcut to install, check out this post: [Update SSMS With PS1](../2017/2017-07-03-update-ssms-with-ps1)
{{< /admonition >}}
