...
<GistWindow
  user="sheldonhull"
  gistId="88ff6ce9caa927a27804"
  filename="ListOutSqlServerDlls.bat"
  title="If you need to quickly find out about all the versions of a SQL server DLL, this quick command in a batch file will help."lang="text"
/>
