...
<GistWindow
  user="sheldonhull"
  gistId="fd2e49f4f69202cd2da6"
  filename="ChangeDatabaseName_ProcAndFunction.sql"
  title="Replace All references to database name in server to a new database name - Proc and functions only"
  lang="sql"
/>
