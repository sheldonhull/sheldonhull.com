...
<Aside type="warning" title="Name Of Project">
...
<GistWindow
  user="sheldonhull"
  gistId="cc8abcb86c9463b0c74bb9e4d82ffac9"
  filename="01-diagram-vpc-example.py"
  title="[Diagrams As Code] Paired with blog post, this is supporting code for generating diagrams via code #python #devops #cloud #aws #diagrams"
  lang="python"
/>
...
<GistWindow
  user="sheldonhull"
  gistId="cc8abcb86c9463b0c74bb9e4d82ffac9"
  filename="03-diagram-complex.py"
  title="[Diagrams As Code] Paired with blog post, this is supporting code for generating diagrams via code #python #devops #cloud #aws #diagrams"
  lang="python"
/>
