...
<Aside type="note" title="Update 2021-06-30">
...
<GistWindow
  user="sheldonhull"
  gistId="f36ea328a2167e93a7015906beb08bbe"
  filename="azure-pipelines.renovate.yml"
  title="[renovate configuration json] How to configure json for renovate automerge with GitHub for pull request workflow #devops"
  lang="yaml"
/>
