...
- golang
- microblog
date: '2021-07-24T22:28:32+00:00'
---
...
<FAIcon style="solid" icon="play" /> [Playground - Demonstrate Problem](https://play.golang.org/p/eVT1Qbnyzgb)
...
<FAIcon style="solid" icon="play" /> [Playground - Fixed The Problem](https://play.golang.org/p/_GX1pYQIySx)
