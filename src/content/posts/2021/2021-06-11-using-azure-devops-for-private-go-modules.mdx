...
<ComparisonCards items={[
  {
    title: "Support All Azure DevOps (Public)",
    command: `git config --global url."git@ssh.dev.azure.com:v3/<organization>/".insteadOf "https://dev.azure.com/<organization>"`,
    gitConfig: `[url "git@ssh.dev.azure.com:v3"]
    insteadOf = https://dev.azure.com`
  },
  {
    title: "What I Used for Private Org",
    command: `git config --global url."git@ssh.dev.azure.com:v3/<organization>/".insteadOf "https://dev.azure.com/"`,
    gitConfig: `[url "git@ssh.dev.azure.com:v3/<organization>/"]
    insteadOf = https://dev.azure.com/`,
    highlighted: true
  }
]} />
...
<Aside type="tip" title="Organization in Dependency Path">
